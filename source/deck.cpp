...
void Deck::shuffleDeck() { // shuffle deck according to rand num gen
    static int offset = 0;
...
void Deck::displayCard(uint8_t &index) {// prints to screen card at index
    std::cout << deck[index];
}


void Deck::resetDeck() { // clears deck, fills deck with new cards and shuffles
